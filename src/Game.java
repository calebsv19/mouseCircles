...
public class Game extends Canvas implements Runnable{
    ...
    public static final int X_DIMENSION = 1400, Y_DIMENSION = 800, TICKS = 300, CIRCLES = 100;
    ...
    public Game(){
        handler = new Handler(CIRCLES);
        // this.addKeyListener(new KeyInput());
        new Window(X_DIMENSION, Y_DIMENSION, "Mouse circles", this);
    }
